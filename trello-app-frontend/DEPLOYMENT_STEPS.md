...
Create a `.env` file in the `trello-app-frontend` directory with your backend configuration.

**After deploying the backend, you'll get these values from:**
- API Gateway URL: Check CloudFormation stack outputs
- User Pool ID: Check CloudFormation stack outputs or Cognito console
- User Pool Client ID: Check CloudFormation stack outputs or Cognito console
...
4. **Configure Build Settings:**
   ...
   - Add environment variables (replace with your values from backend deployment):
     ```
...
- After deploying backend with `sam deploy`, check CloudFormation stack outputs
- Or check AWS Console: API Gateway, Cognito User Pools
